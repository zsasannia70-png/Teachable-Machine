...
Check here : Unsupervised Learning
Your Task
...
Pick a Theme: Choose 3-4 objects or hand signals to teach the computer. (e.g., "Phone vs. Calculator," "Mask On vs. Mask Off," or "Rock, Paper, Scissors").
Train the Model: Use the Teachable Machine website to record your data and train your model.
Test It: Ensure your model is at least 90% confident when you show it the objects!
...
Create a Repository: Name it AI-Object-Detector.
The README: Copy the template provided in class and fill in your details.
Visuals: Upload a screenshot of your "Preview" window showing the AI correctly identifying an object.
Live Link: Export your model and paste the shareable link in your README so the teacher (and your friends) can try it!
